...
`,
helpRefresh: `# Rafraichissement de la couche
----
...
Vous devez également préciser l'identifiant permettant de différencier les objets du calque, afin de conserver la sélection des objets entre deux rafraichissments.
